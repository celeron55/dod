...
minetest.register_node("default:torch", {
    ...
    on_place = function(itemstack, placer, pointed_thing)
		local itemstack1 = ItemStack(itemstack)
		local itemstack1, success = minetest.item_place(itemstack1, placer, pointed_thing)
		return itemstack -- Return original stack for infinite torches
	end,
